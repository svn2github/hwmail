<?xml version="1.0" ?>
<!-- 
    This is the XSL HTML configuration file for the HANDY-QIS Reference Documentation.
-->
...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0" xmlns="http://www.w3.org/TR/xhtml1/transitional"
    ...
    <!--###################################################
                     Headers and Footers
    ################################################### -->
    <!-- let's have a HEDWIG and HANDYSOFT banner across the top of each page -->
    <xsl:template name="user.header.navigation">
        <div style="background-color:white;border:none;height:73px;border:1px solid black;">
            <!-- a style="border:none;" href="http://www.hedwig.org/" title="Hedwig Home Page" -->
                <img style="border:none;" src="images/xdev_logo.jpg" />
            <!-- /a -->
        </div>
    </xsl:template>
                            ...
                            <tr>
                                ...
                                <td width="20%" align="center">
                                    <span style="color:white;font-size:90%;">
                                        <!--a href="http://www.handysoft.co.kr/" title="HandySoft Corp.">Sponsored by HandySoft Corp.</a -->
                                    </span>
                                </td>
